...
GetUserOrdersModel getUserOrdersModelFromJson(String str) => GetUserOrdersModel.fromJson(json.decode(str));

String getUserOrdersModelToJson(GetUserOrdersModel data) => json.encode(data.toJson());
...
class GetUserOrdersModel {
  ...
  factory GetUserOrdersModel.fromJson(Map<String, dynamic> json) => GetUserOrdersModel(
...
class Order {
  ...
  factory Order.fromJson(Map<String, dynamic> json) => Order(
    ...
    promoCodeFk: json["promo_code_fk"] == null ? null : json["promo_code_fk"],
    promoCodePercent: json["promo_code_percent"] == null ? null : json["promo_code_percent"],
  ...
  Map<String, dynamic> toJson() => {
    ...
    "promo_code_percent": promoCodePercent == null ? null : promoCodePercent,
...
class CancelOrdersModel {
  ...
  factory CancelOrdersModel.fromJson(Map<String, dynamic> json) => CancelOrdersModel(
...
class GetOrderStatusModel {
  ...
  factory GetOrderStatusModel.fromJson(Map<String, dynamic> json) => GetOrderStatusModel(
