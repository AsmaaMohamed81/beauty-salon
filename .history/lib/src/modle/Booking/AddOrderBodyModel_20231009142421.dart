// To parse this JSON data, do // //     final addOrderBodyModel = addOrderBodyModelFromJson(jsonString);

import 'dart:convert';

AddOrderBodyModel addOrderBodyModelFromJson(String str) =>
    AddOrderBodyModel.fromJson(json.decode(str));

String addOrderBodyModelToJson(AddOrderBodyModel data) =>
...
class AddOrderBodyModel {
  ...
  Map<String, dynamic> toJson() => {
        ...
        "service_details": serviceDetails == null
            ? null
            : List.from(serviceDetails.map((x) => x.toJson())),
      };
}
