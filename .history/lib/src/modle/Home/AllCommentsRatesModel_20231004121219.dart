...
AllCommentsRatesModel allCommentsRatesModelFromJson(String str) =>
    AllCommentsRatesModel.fromJson(json.decode(str));

String allCommentsRatesModelToJson(AllCommentsRatesModel data) =>
...
class AllCommentsRatesModel {
  ...
  factory AllCommentsRatesModel.fromJson(Map<String, dynamic> json) =>
      AllCommentsRatesModel(
