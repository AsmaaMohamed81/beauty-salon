...
NotifactionsModel notifactionsModelFromJson(String str) => NotifactionsModel.fromJson(json.decode(str));

String notifactionsModelToJson(NotifactionsModel data) => json.encode(data.toJson());
...
class NotifactionsModel {
  ...
  factory NotifactionsModel.fromJson(Map<String, dynamic> json) => NotifactionsModel(
