      ...
      content: SizedBox(
        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              height: 300,
              child: widget.storesServices?.length != 0
                  ? Center(
                          ...
                          itemBuilder: (c, index) => Padding(
                                ...
                                child: Theme(
                                  ...
                                  child: CheckboxListTile(
                                      value: widget.storesServices[index]
                                                  .isSelected ==
                                              null
                                          ? _accept
                                          : widget
                                              .storesServices[index].isSelected,
                                      onChanged: (value) {
                                        setState(() {
                                          for (var i = 0;
                                              i < widget.storesServices.length;
                                              i++) {
                                            if (widget.storesServices[i]
                                                    .isSelected ==
                                                null) {
                                              widget.storesServices[i]
                                                  .isSelected = false;
                                            }
                                          }
                                          widget.storesServices[index]
                                                  .isSelected =
                                              !widget.storesServices[index]
                                                  .isSelected;
                                          _itemChange(
