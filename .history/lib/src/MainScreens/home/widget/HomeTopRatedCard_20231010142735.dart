                ...
                child: Padding(
                  ...
                  child: Container(
                      ...
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(10),
                        child: Image.network(
                          AppConfig.MAIN_Image_URL + store!.mainImage!,
                          fit: BoxFit.fill,
                        ),
                      )),
                ),
                        ...
                        Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: CustomImageNetwork(
                                  image: AppConfig.MAIN_Image_URL +
                                      store!.mainImage!),
                        ...
                        Text(
                            lang == "ar"
                                ? store!.storeName!.length > 20
                                    ...
                                    : store!.storeName!
                                : store!.storeNameEn!.length > 20
                                    ? '${store!.storeNameEn!.substring(0, 20)}...'
                                    : store!.storeNameEn!,
                            style: TextStyle(
                        ...
                        Text(
                            lang! == "ar"
                                ? store!.address!.length > 40
                                    ...
                                    : store.address
                                : store.addressEn.length > 40
                                    ? '${store.addressEn.substring(0, 40)}...'
                                    : store.addressEn,
                            style: TextStyle(
