  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
        ...
        body: Consumer<HomeProvider>(builder: (context, snapshot, child) {
          Provider.of<BookingProvider>(context, listen: false).allBarbersModel =
          ...
          return ListView(
            children: [
                ...
                child: snapshot.allBarbersModel!.stores!.isEmpty
                    ...
                    : Container(
                        ...
                        child: ListView.builder(
                            ...
                            itemBuilder: (c, index) => HomeTopRatedCard(
                                  store:
                                      snapshot.allBarbersModel!.stores![index],
                                )),
                      ),
              ),
              const SizedBox(height: 10),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 15, right: 15),
                child: snapshot.allOffersModel!.offers!.isEmpty
                    ? Container()
                    : Container(
                        height: 150,
                        child: ListView.builder(
                            ...
                            itemBuilder: (c, index) => HomeOfferCard(
                                  offer:
