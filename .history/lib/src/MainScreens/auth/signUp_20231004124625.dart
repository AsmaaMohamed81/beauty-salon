...
import 'package:beauty_salon/src/MainWidgets/terms_dialog.dart';
          ...
          child:  Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  CustomMoveList(data: [
                    Text(tr("Register a new account"),
                    ...
                    RegisterTextField(
                        ...
                        prefixIcon: const Icon(Icons.person,color: Color(0xff8a8a8a),),
                        type: TextInputType.text),
                    const  SizedBox(height: 20),
                    RegisterTextField(
                        hint: tr("phone number"),
                        onChange: (v) {login.phone = v;},
                        fillColor: Colors.white,
                        textStyle: const TextStyle(
                          fontFamily: 'DINNextLTW232',
                          color: Color(0xff8a8a8a),
                          ...
                          fontWeight: FontWeight.w400,
                          fontStyle: FontStyle.normal,
                        ),                  prefixIcon: const Icon(Icons.phone_in_talk,color: Color(0xff8a8a8a),),
                    ...
                    const SizedBox(height: 20),
                    RegisterSecureTextField(
                      onChange: (v) {login.passwordConfirmation = v;},
