        ...
        children: [
          CustomMoveList(data: [
            Padding(
              ...
              child: Container(
                  height: 110, child: Image.asset("assets/images/logo.png")),
            ),
            const SizedBox(height: 50),
            Text(
              tr("Welcome, what are you looking for?"),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                        height: 90,
                                        child: Image.asset(
                                            "assets/images/scissors-icon.png")),
                                  ),
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Container(
                                        height: 90,
                                        child: Image.asset(
                                            "assets/images/hair-dryer-icon.png")),
                                  ),
                                  const SizedBox(height: 10),
