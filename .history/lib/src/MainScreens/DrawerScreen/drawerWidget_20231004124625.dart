            ...
            children: [
              Container(
                ...
                child: ClipRRect(
                  ...
                  child:
                  NetworkUtil.userModel.member.mImage == null ?
                  const CustomImageNetwork(
                      image:
                      "https://upload.wikimedia.org/wikipedia/commons/a/a0/Andrzej_Person_Kancelaria_Senatu.jpg")
                :  CustomImageNetwork(image: AppConfig.MAIN_UserImage_URL + NetworkUtil.userModel.member.mImage))),
              SizedBox(height: 17),
              Text(
                "${NetworkUtil.userModel.member.userName}",
                  style: TextStyle(
            ...
            children: [
              Expanded(
                  child: ListView(
                    ...
                    children: [
                      drawerItem(
                          tr("personal page"), Icons.person, () => push(EditProfile()),
                          visable:
                          NetworkUtil.userModel.token == null),
                      // drawerItem(
                      //     "الصفحة الشخصية", Icons.person, () => push(EditProfile()),
                      //     visable:
                      //     NetworkUtil.userModel.data[0].accessToken != null),
                      drawerItem(tr("Orders"), Icons.article_outlined, () {push(MyOrdersScreens());}),
                      drawerItem(tr("Reservations"), null, ()=>push(MyReservationsScreens())),
                      drawerItem(tr("contact us"), Icons.question_answer,
                              () => push(ContactUs())),
                      drawerItem(tr("who are we"), FontAwesomeIcons.question,
                              () => push(AboutUs())),
                      drawerItem(
                          tr("change the language"), Icons.language, () {
                            pop();
                        push(SplashPage());
          ...
          child: InkWell(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(width: 10),
                icon != null
                    ? Icon(icon, color: Color(0xff3a3a3a),)
