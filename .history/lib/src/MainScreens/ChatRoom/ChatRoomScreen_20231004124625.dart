                 ...
                 Positioned.fill(
                    child: Padding(
                      ...
                      child: Align(
                          ...
                          child: Text(tr("My Correspondence"),
                                  ...
                                  Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                          builder: (context) => ChatScreen(
                                            StoreName: snapshot.allBarbersModel.stores[index].storeName,
                                            StoreId: snapshot.allBarbersModel.stores[index].storeId,
                                          )));
                                },
                                child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            Text(snapshot.allBarbersModel.stores[index].storeName,
                                              style: TextStyle(
                                                fontFamily: 'DINNextLTW232',
                                        ...
                                        Container(
                                          ...
                                          //       "https://upload.wikimedia.org/wikipedia/commons/a/a0/Andrzej_Person_Kancelaria_Senatu.jpg"),
                                            child:Image.network(AppConfig.MAIN_Image_URL+snapshot.allBarbersModel.stores[index].mainImage,fit: BoxFit.fill,),
                                            ),
                                          ),
                                      ],
                                    ),
