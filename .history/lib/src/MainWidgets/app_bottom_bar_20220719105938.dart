          ...
          items: [
            BottomNavigationBarItem(
              ...
              icon: Padding(
                  ...
                  child: SvgPicture.asset("assets/icon/Glyph.svg", color: disActiveColor)),
              activeIcon: Padding(
                padding: const EdgeInsets.all(8.0),
            ...
            BottomNavigationBarItem(
              ...
              icon: Padding(
                padding: const EdgeInsets.all(8.0),
                child: SvgPicture.asset("assets/icon/not.svg", color: disActiveColor),
              ),
              activeIcon: Padding(
                padding: const EdgeInsets.all(8.0),
            ...
            BottomNavigationBarItem(
              ...
              icon: Padding(
                padding: const EdgeInsets.all(8.0),
                child: SvgPicture.asset("assets/icon/Messeges.svg", color: disActiveColor),
                // child: Icon(Icons.article_outlined,color: disActiveColor,)
              ),
              activeIcon: Padding(
                padding: const EdgeInsets.all(8.0),
                child: SvgPicture.asset("assets/icon/Messeges.svg", color: activeColor,),
            ...
            BottomNavigationBarItem(
              ...
              icon: Padding(
                padding: const EdgeInsets.all(8.0),
                child: SvgPicture.asset("assets/icon/Offers.svg", color: disActiveColor),
              ),
              activeIcon: Padding(
                padding: const EdgeInsets.all(8.0),
                child: SvgPicture.asset(
