...
AllOffersModel allOffersModelFromJson(String str) =>
    AllOffersModel.fromJson(json.decode(str));
...
class Offer {
  ...
  factory Offer.fromJson(Map<String, dynamic> json) => Offer(
        ...
        offerNameEn:
            json["offer_name_en"] == null ? null : json["offer_name_en"],
        ...
        storeNameEn:
            json["store_name_en"] == null ? null : json["store_name_en"],
        mainFe2AIdFk:
            json["main_fe2a_id_fk"] == null ? null : json["main_fe2a_id_fk"],
        ...
        storesDays: json["stores_days"] == null
            ? null
            : List<StoresDay>.from(
                json["stores_days"].map((x) => StoresDay.fromJson(x))),
        storesServices: json["stores_services"] == null
            ? null
            : List<StoresService>.from(
                json["stores_services"].map((x) => StoresService.fromJson(x))),
        storesImages: json["stores_images"] == null
            ? null
            : List<StoresImage>.from(
                json["stores_images"].map((x) => StoresImage.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "stores_days": storesDays == null
            ? null
            : List<dynamic>.from(storesDays!.map((x) => x.toJson())),
        "stores_services": storesServices == null
            ? null
            : List<dynamic>.from(storesServices!.map((x) => x.toJson())),
        "stores_images": storesImages == null
            ? null
            : List<dynamic>.from(storesImages!.map((x) => x.toJson())),
