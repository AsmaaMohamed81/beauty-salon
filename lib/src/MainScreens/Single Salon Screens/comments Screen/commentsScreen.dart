...
class _CommentsScreenState extends State<CommentsScreen> {
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
        ...
        service: Provider.of<HomeProvider>(context, listen: false).AllCommentsRatesAPI(widget.storeIdFk),
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Text(snapshot.allCommentsRatesModel.rating[index].userName,
                                          style: TextStyle(
                                            fontFamily: 'DINNextLTW232',
                                        ...
                                        SizedBox(height: 7,),
                                        Text(snapshot.allCommentsRatesModel.rating[index].comment ?? "",
                                            style: TextStyle(
                                              fontFamily: 'DINNextLTW232',
                                        ...
                                        SizedBox(height: 7,),
                                        Text(snapshot.allCommentsRatesModel.rating[index].date,
                                            style: TextStyle(
                                              fontFamily: 'DINNextLTW232',
                                    ...
                                    SizedBox(
                                        ...
                                        child: Center(
                                          child: SmoothStarRating(
                                            rating: double.parse(snapshot.allCommentsRatesModel.rating[index].rate),
                                            isReadOnly: true,
                                            size: 17,
                                            color: Colors.amber,
