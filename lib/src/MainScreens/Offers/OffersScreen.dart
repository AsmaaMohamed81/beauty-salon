...
class _OffersScreenState extends State<OffersScreen> {
  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
        ...
        service: Provider.of<HomeProvider>(context, listen: false).allOffersAPI(),
        body:  Consumer<HomeProvider>(builder: (context, snapshot, child) {
          return SafeArea(
              child: Padding(
                  padding: const EdgeInsets.only(
                      left: 8, right: 8, top: 8, bottom: 30),
                  child: snapshot.allOffersModel.offers.length == 0 ? AppEmpty() :
                  ListView.builder(
                      addAutomaticKeepAlives: true,
                      itemCount: snapshot.allOffersModel.offers.length,
                      itemBuilder: (c, index) =>
                          InkWell(
                            onTap: ()=>push( SingleSalonOfferScreen(offer: snapshot.allOffersModel.offers[index],)),
                            child: Padding(
                                padding: const EdgeInsets.only(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children:  [
                                             Text(snapshot.allOffersModel.offers[index].storeName,
                                              style: TextStyle(
                                                fontFamily: 'DINNextLTW232',
                                            ...
                                            SizedBox(
                                              ...
                                              child: Text(snapshot.allOffersModel.offers[index].offerDetails,
                                                  maxLines: 2,
                                            ...
                                            SizedBox(
                                              ...
                                              child: Row(
                                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                                children: [
                                                  Text(tr("the end of the show") + snapshot.allOffersModel.offers[index].toDate,
                                                      style: TextStyle(
                                                        fontFamily: 'DINNextLTW232',
                                                  ...
                                                  Text( snapshot.allOffersModel.offers[index].offerPrice +"%خصم ",
                                                      style: TextStyle(
                                                        fontFamily: 'DINNextLTW232',
                                        ...
                                        Container(
                                          ...
                                          child:
                                          CustomImageNetwork(image: AppConfig.MAIN_Image_offer_URL+ snapshot.allOffersModel.offers[index].offerImg),),
                                      ],
                                    ),
                                  ),
                                )
