  ...
  Widget build(BuildContext context) {
    return CustomScaffold(
      appBar: PreferredSize(
        ...
        service: Provider.of<NotifactionsProvider>(context, listen: false).myNotificationAPI(),
        body: Consumer<NotifactionsProvider>(builder: (context, snapshot, child) {
          return SafeArea(
              child:Padding(
                  padding: const EdgeInsets.only(left: 8,right: 8,top: 8,bottom: 30),
                  child:  snapshot.notifactionsModel.notification.length == 0 ? AppEmpty():
                  ListView.builder(
                      addAutomaticKeepAlives: true,
                      itemCount: snapshot.notifactionsModel.notification.length,
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    Row(
                                        ...
                                        children: [
                                          Text(snapshot.notifactionsModel.notification[index].dateAr.toString(),
                                            style: TextStyle(color: Colors.grey),
                                          ),
                                        ]),
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(snapshot.notifactionsModel.notification[index].title,
                                          style: TextStyle(
                                            fontFamily: 'DINNextLTW232',
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                          ...
                                          child: Text(
                                              snapshot.notifactionsModel.notification[index].body,
                                              style: TextStyle(
                                                fontFamily: 'DINNextLTW232',
