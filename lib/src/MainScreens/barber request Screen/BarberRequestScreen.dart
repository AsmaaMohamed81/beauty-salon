                  ...
                  Theme(
                    ...
                    child: Container(
                      ...
                      child: DropdownButtonFormField<Store>(
                        ...
                        value: selectedValue ,
                        hint: Text(tr("Choose a salon"), style: TextStyle(
                          fontFamily: 'DINNextLTW232',
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          selectedValue == null ?  CustomAlert().toast(title:tr("Salon must be chosen")) :
                          showDialog(
                              context: context,
                              builder: (_) {
                                return  ShowServicesDialog(storesServices: selectedValue.storesServices);
                              });
                        },
                        child: Container(
                          width: MediaQuery.of(context).size.width*0.4,
                    ...
                    onTap: (){
                      ...
                      Provider.of<BookingProvider>(context, listen: false).discountCode = discountCode.text;
                        ...
                        if(snapshot.selectedDateVall== null){
                          CustomAlert().toast(title:tr(tr("The date of the visit must be specified")));
                          return;
                        }
