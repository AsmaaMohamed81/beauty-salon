...
class _MyReservationsScreensState extends State<MyReservationsScreens> {
  @override
  void initState() {
    Provider.of<ReservationsProvider>(context, listen: false).orderType = "salon";
          ...
          children: [
            ...
            Expanded(
              ...
              ListView.builder(
                  ...
                  itemBuilder: (c, index) =>
                      MyReservationCard(order: snapshot.getUserOrdersModel.orders[index],)),
            ),
