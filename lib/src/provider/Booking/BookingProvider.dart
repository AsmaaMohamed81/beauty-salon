...
class BookingProvider extends ChangeNotifier {
  ...
  Future<ErrorModel> storeOrderApi2(String store_id_fk ) async {
    AddOrderBodyModel bodys = AddOrderBodyModel();
    ...
    final response = await http.post(Uri.parse(AppConfig.MAIN_API_URL + "Api/add_order"),body:body,headers: {
  ...
  Future<ErrorModel> addOrderToHomeApi(String store_id_fk ) async {
    ...
    final response = await http.post(Uri.parse(AppConfig.MAIN_API_URL + "Api/add_order_home"),body:body,headers: {
      "Accept":"application/json",
      "content-type":"application/json",
      "lang": appContext.locale.languageCode,
      "type":NetworkUtil.KuafirTypeSelected//1 as man  2 as women
